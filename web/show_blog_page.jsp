                        ...
                        <div class="card-body">
                            ...
                            <div class="row my-3 row-user">
                                <div class="col-md-8">
                                    ...
                                    <p class="post-user-info"><a href="#!"> <%= udo.getUSerByPostId(p.getUserId()).getName()%> </a> has Posted : &nbsp;<em><strong><%= DateFormat.getDateTimeInstance().format(p.getpDate())%></strong></em> </p>
