...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark primary-background">
            <a class="navbar-brand" href="admin.jsp"> <span class="fa fa-asterisk"></span> Blogify</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="#" data-toggle="modal" data-target="#manage-post-modal"> <span class="fa fa-trash"></span>  Delete Post</a>
                    </li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="manage-post-form"  action="ManagePostServlet" method="post">
                        ...
                        <div class="container text-center" >
                            <button type="submit" class="btn btn-primary primary-background">Delete Post</button>
                            &nbsp;<button type="reset" class="btn btn-primary primary-background">Reset</button>
                        </div>
                    </form>
                </div>
